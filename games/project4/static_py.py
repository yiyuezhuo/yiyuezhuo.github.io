...
class Scenario(object):
    ...
    def to_json(self,sort=True):
        ...
        big_dic={'unit_dic_list':unit_dic_list,'hex_dic_list':hex_dic_list,'size':self.size,
                 ...
                 'setting':setting,'script':script,'terrain':terrain}
...
class CSV_model(object):
    def __init__(self,scenario=None):
        ...
        self.register=['AI.csv','block.csv','capture.csv','color.csv',
                       ...
                       'VP.csv','CRT.csv','setting.csv','place.csv','terrain_type.csv']
    ...
    def parse_terrain(self):
        #'terrain_type.csv'
        terrain_l=self.pick_from_head(self.csv['terrain_type.csv'])
        terrain_d={terrain['name']:terrain for terrain in terrain_l}
        self.scenario.terrain=terrain_d
